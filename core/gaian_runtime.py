<<<<<<< Updated upstream
# F841 fix: remove unused idx assignment is handled inline below
# This file is large — patching only the affected function signature area
# via a targeted push of the corrected file.
=======
"""
