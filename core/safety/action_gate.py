...
Note: v1 consent-gate symbols (ActionRiskLevel, GateRequirement, ConsentReceipt,
DelegationScope, PERMISSION_GRANT, PERMISSION_DENY) are re-exported below from
core.agent.action_gate so both import paths work identically.
"""
...
# ---------------------------------------------------------------------------
# v1 re-exports — keeps core.agent.action_gate symbols importable from here
# ---------------------------------------------------------------------------

from core.agent.action_gate import (  # noqa: E402, F401
    ActionRiskLevel,
    GateRequirement,
    ConsentReceipt,
    DelegationScope,
