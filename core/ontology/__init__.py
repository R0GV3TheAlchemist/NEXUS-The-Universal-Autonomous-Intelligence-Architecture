...
This package is the semantic foundation of GAIA-OS. Every module that creates,
relates, or transitions entities must import from here. Where any other module
conflicts with C03 definitions, C03 governs.
"""
